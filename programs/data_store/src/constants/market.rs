...
pub const DEFAULT_SWAP_IMPACT_EXPONENT: Factor = 2 * super::MARKET_USD_UNIT;
...
pub const DEFAULT_MAX_POSITION_IMPACT_FACTOR_FOR_LIQUIDATIONS: Factor = 250_000_000_000_000_000;
...
pub const DEFAULT_POSITION_IMPACT_POSITIVE_FACTOR: Factor = 9_000_000_000;
/// Default position impact negative factor.
pub const DEFAULT_POSITION_IMPACT_NEGATIVE_FACTOR: Factor = 15_000_000_000;
...
pub const DEFAULT_POSITION_IMPACT_DISTRIBUTE_FACTOR: Factor = super::MARKET_USD_UNIT;
/// Default min position impact pool amount.
pub const DEFAULT_MIN_POSITION_IMPACT_POOL_AMOUNT: Factor = 1_000_000_000;

/// Default borrowing fee factor for long.
pub const DEFAULT_BORROWING_FEE_FACTOR_FOR_LONG: Factor = 2_820_000_000_000;
/// Default borrowing fee factor for short.
pub const DEFAULT_BORROWING_FEE_FACTOR_FOR_SHORT: Factor = 2_820_000_000_000;
...
pub const DEFAULT_FUNDING_FEE_MAX_FACTOR_PER_SECOND: Factor = 1_000_000_000_000;
...
pub const DEFAULT_FUNDING_FEE_INCREASE_FACTOR_PER_SECOND: Factor = 790_000_000;
...
pub const DEFAULT_RESERVE_FACTOR: Factor = super::MARKET_USD_UNIT;
/// Default open interest reserve factor.
pub const DEFAULT_OPEN_INTEREST_RESERVE_FACTOR: Factor = super::MARKET_USD_UNIT / 100 * 95;
...
pub const DEFAULT_MAX_POOL_AMOUNT_FOR_LONG_TOKEN: Factor = 1_000_000_000 * super::MARKET_USD_UNIT;
/// Default max pool amount for short token.
pub const DEFAULT_MAX_POOL_AMOUNT_FOR_SHORT_TOKEN: Factor = 1_000_000_000 * super::MARKET_USD_UNIT;

/// Default max pool value for deposit for long token.
pub const DEFAULT_MAX_POOL_VALUE_FOR_DEPOSIT_LONG_TOKEN: Factor =
    1_000_000_000_000_000 * super::MARKET_USD_UNIT;
/// Default max pool value for deposit for short token.
pub const DEFAULT_MAX_POOL_VALUE_FOR_DEPOSIT_SHORT_TOKEN: Factor =
    1_000_000_000_000_000 * super::MARKET_USD_UNIT;

/// Default max open interest for long.
pub const DEFAULT_MAX_OPEN_INTEREST_FOR_LONG: Factor = 1_000_000_000 * super::MARKET_USD_UNIT;
/// Default max open interest for short.
pub const DEFAULT_MAX_OPEN_INTEREST_FOR_SHORT: Factor = 1_000_000_000 * super::MARKET_USD_UNIT;
